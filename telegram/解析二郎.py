...
insert_sql = '''
insert into spider_base.`dwd_building_phoenix`(channel_id,message_id,group_id,province,city,area,if_sw,if_by,if_door,if_96,remark,min_price,real_content,age,city_id) values("{}","{}","{}","{}","{}","{}","{}","{}","{}","{}","{}","{}","{}","{}","3100")
'''
