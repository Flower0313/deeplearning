...
def main():
    client.start()
    # 频道实体
    entity = client.get_entity(Channel(id=1401936463, title='上海赛车交流群',
                                       photo=ChatPhoto(photo_id=5161357440959229444, dc_id=1, has_video=False,
                                                       stripped_thumb=''),
                                       date=datetime.datetime(2023, 5, 30, 10, 37, 41, tzinfo=datetime.timezone.utc),
